...
set HAPIDir=K:\lib-x64-msvc2019\h3d\hapi-1.4.0\build\Release
set H3DUtilDir=K:\lib-x64-msvc2019\h3d\h3dutil-1.4.0\build\Release
set PthreadsDir=K:\lib-x64-msvc2019\pthreads\pthreads-w32-2-9-1-release\Pre-built.2\dll\x64
set VTKDir=K:\lib-x64-msvc2019\VTK-9.0.1-build\bin\Release
set VirtuoseDir=K:\lib-x64-msvc2019\Virtuose\VirtuoseAPI_v3_97\win\bin\VC2017\x64\Release
